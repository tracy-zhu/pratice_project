...
def get_price_series(trading_day, instrument_date):
    rm_quote_data = read_minute_data('C1' + instrument_date, trading_day)
    m_quote_data = read_minute_data('CS1' + instrument_date, trading_day)
...
c_close_price_series, cs_close_price_series = get_price_series(trading_day, '801')
beta1, std1 = linear_model_main(cs_close_price_series, c_close_price_series)

out_put_file_name = "D:\\pairs_trading_parameter\\c_cs_parameter_result_file_801.txt"
...
c_close_price_series, cs_close_price_series = get_price_series(trading_day, '709')
beta2, std2 = linear_model_main(cs_close_price_series, c_close_price_series)

out_put_file_name = "D:\\pairs_trading_parameter\\c_cs_parameter_result_file_709.txt"
out_put_file = open(out_put_file_name, 'wb')
